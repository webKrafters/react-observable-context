    ...
    return (
        <>
            ...
            <div className="snippet-intro" id="provider-usage">
                <h3>Providing the <Name /> store</h3>
...
function BodyPre7_0_0() {
    return (
        <>
            <Paragraph className="snippet-intro" id="install">
                <Name /> and the React.Context API share a similar setup flow. Let us begin by installing the React Observable Context package.
            </Paragraph>
            <Paragraph className="snippet-box">
                <CodeBlock isInline>
                    npm install --save @webkrafters/react-observable-context
            ...
            <div className="snippet-intro" id="connect-usage">
                <h3>Consuming the <Name /> store</h3>
            ...
            <div className="snippet-intro" id="usecontext-usage">
                <h3>Consuming the <Name /> store (React Hook method)</h3>
